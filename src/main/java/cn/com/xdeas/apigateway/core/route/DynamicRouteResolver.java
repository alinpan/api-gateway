package cn.com.xdeas.apigateway.core.route;

import cn.com.xdeas.apigateway.model.ReturnData;
import cn.com.xdeas.apigateway.util.ReturnDataUtil;
import cn.com.xdeas.apigateway.common.enums.UrlProtocal;
...
import static cn.com.xdeas.apigateway.common.constants.StringConsts.GATEWAY_ROUTES;
...
public class DynamicRouteResolver implements ApplicationEventPublisherAware {
    ...
    private RouteDefinition assembleRouteDefinition(RouteDefinition gwdefinition) {
        ...
        definition.setUri(UrlProtocal.LB.toString().toLowerCase().equals(schema) ? gwdefinition.getUri()
